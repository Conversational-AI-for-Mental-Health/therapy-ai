      ...
      <div className="w-full max-w-sm">
        <div className="bg-surface rounded-2xl shadow-xl" style={{ padding: 'var(--space-lg)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xs)', marginBottom: 'var(--space-md)' }}>
            <div className="flex flex-col items-center" style={{ gap: 'var(--space-xxs)' }}>
              <button
                disabled
                className="w-full bg-surface border border-color rounded-lg text-body flex items-center justify-center opacity-50 cursor-not-allowed"
              ...
              <span className="text-caption text-secondary">Coming Soon</span>
            </div>
            <div className="flex flex-col items-center" style={{ gap: 'var(--space-xxs)' }}>
              <button
                disabled
