...
The mobile client uses **Jest** for unit/integration tests and **Detox** for end-to-end (E2E) testing.

### 1. Unit & Integration Tests

These tests validate components, services, and hooks in isolation or in small groups.
...
E2E tests run on a real simulator to validate full user flows (Auth, Chat, Journal).

**Prerequisites:**

- Backend, Mobile and AI running.
- Project dependencies installed.

**Run on iOS:**

```bash
# Build the test app (required once or after native changes)
...
> **Note:** E2E tests are state-aware and handle iOS keychain persistence automatically by checking for the Dashboard state on startup.
